...
const SellerLogin = () => {
    ...
    function onSubmit(data) {
        SellerServices.loginSeller(data).then(res => {
                    ...
                    <div className="not-found">
                        ...
                        <div className="form-container">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <h3 className="text-center"><strong>Seller Login</strong></h3>
                                ...
                                <p className="forgot-password text-right">
                                    Not an account? <Link className="Link" aria-current="page" exact to="/SellerSignUp">SignUp here.</Link>
                                </p>
                            </form>
                        </div>
                    </div>
