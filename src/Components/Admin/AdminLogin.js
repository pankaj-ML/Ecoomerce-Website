...
const AdminLogin = () => {
    ...
    function onSubmit(data) {
        AdminServices.loginAdmin(data).then(res => {
                    ...
                    <div className="not-found">
                        ...
                        <div className="form-container">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <h3 className="text-center"><strong>Admin Login</strong></h3>
                                ...
                                <p className="forgot-password text-right">
                                    Not an account? <Link className="Link" aria-current="page" exact to="/AdminSignUp">SignUp here.</Link>
                                </p>
